    ...
    switch (gameState) {
        case IN_MENU:
            ...
            break;
                ...
                ballSpeedController.value = (oldValue < 10) ? oldValue ++ : ballSpeedController.value;
                changeBallSpeed();
            }
            else if (code == "ArrowDown") {
                var oldValue = Number(ballSpeedController.value);
                ballSpeedController.value = (oldValue > 1) ? oldValue -- : ballSpeedController.value;
                changeBallSpeed();
            }
            else if (code == "ArrowLeft") {
                var oldValue = Number(bombSpeedController.value);
                bombSpeedController.value = (oldValue > 1) ? oldValue -- : bombSpeedController.value;
                changeBombFrequency();
            }
            else if (code == "ArrowRight") {
                var oldValue = Number(bombSpeedController.value);
                bombSpeedController.value = (oldValue < 10) ? oldValue ++ : bombSpeedController.value;
                changeBombFrequency();
            }
        case IN_GAME:
            if (code == "Space") {
                ...
                oldValue = Number(ballSpeedController.value);
            ...
            // }
                ...
                oldValue = Number(bombSpeedController.value);
